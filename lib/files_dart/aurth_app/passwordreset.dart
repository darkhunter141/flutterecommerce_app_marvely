                                ...
                                return Dialog(
                                    child: SingleChildScrollView(
                                      child: Container(
                                        ...
                                        child: Column(
                                  children: [
                                        Image.asset("assets/passreset.png",fit: BoxFit.fill,height: hei/5,
                                        width: wid/3,),
                                        Text ("Reset Password"),
                                        Center(
                                          child: Padding(
                              ...
                              builder: (context) {
                                return Dialog(
                                  ...
                                  children: [
                                      Container(
                                          height: hei / 4,
                                          child: Image.asset("assets/wrong.png",fit: BoxFit.fill,)),
                                    Text ("Wrong username or password!",style: TextStyle(
                                       fontWeight: FontWeight.bold,fontSize: hei/40,color: Colors.red
                                    ),),
                                    Text ("Try Again",style: TextStyle(
                                        fontWeight: FontWeight.bold,fontSize: hei/30,color: Colors.red
                                    ),)
                                  ],
                                ),
                                    ));
